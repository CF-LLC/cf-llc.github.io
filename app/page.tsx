...
import SpaceRig from '@/components/SpaceRig'
    ...
    <div className="site-shell min-h-screen text-white">
      ...
      <SpaceRig>
        <div id="page-top" className="relative z-10">
          ...
          <SpatialScene className="min-h-[92vh]" fromX={-60} fromY={40} fromZ={-420} fromRotateX={18} fromRotateY={22} fromRotateZ={-6}>
            <div className="relative mx-auto flex min-h-[88vh] max-w-7xl flex-col justify-center px-4 pb-24 pt-8 sm:px-6 lg:px-8">
              <motion.p initial={{ opacity: 0, z: -80 }} animate={{ opacity: 1, z: 0 }} className="kicker">
                Cooper Featherstone
              </motion.p>
              <motion.h1
                initial={{ opacity: 0, rotateX: 18, z: -160 }}
          ...
          <SpatialScene id="founder" className="color-panel panel-magenta scroll-mt-24" fromX={120} fromY={70} fromZ={-360} fromRotateX={-12} fromRotateY={-24} fromRotateZ={5}>
            <div className="mx-auto grid max-w-7xl gap-12 px-4 py-24 sm:px-6 lg:grid-cols-[1fr_1fr] lg:px-8 lg:py-32">
              <div>
                ...
                <p className="mt-6 max-w-xl text-lg leading-8 text-white/80">
                  Early-stage product engineer who ships production work. The motion on this page is the craft. The repos are the results.
                </p>
              </div>
          ...
          <SpatialScene id="signals" className="color-panel panel-cyan" fromX={-110} fromY={80} fromZ={-300} fromRotateX={10} fromRotateY={20} fromRotateZ={-4}>
              ...
              <div className="mt-12 grid gap-6 md:grid-cols-3">
                {[
                  ...
                  <motion.div
                    ...
                    className="rounded-[1.75rem] border border-white/15 bg-black/20 p-6"
                  >
          ...
          <SpatialScene id="work" className="color-panel panel-ink scroll-mt-24" fromX={40} fromY={100} fromZ={-240} fromRotateX={16} fromRotateY={-10} fromRotateZ={3}>
            <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8 lg:py-28">
              <ProjectsSection />
            </div>
          </SpatialScene>

          <SpatialScene className="color-panel panel-orange" fromX={-90} fromY={60} fromZ={-320} fromRotateX={-14} fromRotateY={18} fromRotateZ={-5}>
